...
ifrestart=True
nrest=1190 # number of output entry for restart
...
logSE = True # if we work with logarithms of Sigma and E instead of the quantities themselves
...
##################################################
# source term
mdotfinal = 0.01 # Msun/yr, intended mass accretion rate
